...
Scenario: User creates and verifies an Assistant
    ...
    # Search and delete an Assistant  
    ...
    # Archieve an existing Assistant  
    ...
    # Unarchieve an existing Assistant  
    Given user clicks the list of assistants
    When user selects the "Archived Assistant"
    When user searches for any existing assistant "qaassistant1"
    And user clicks on search assistant
